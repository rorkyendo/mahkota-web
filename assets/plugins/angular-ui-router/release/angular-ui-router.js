...
(function (global, factory) {
    ...
    var UrlService = /** @class */ (function () {
        ...
        function UrlService(/** @internal */ router) {
             ...
             *
             * ```
             * http://mysite.com/somepath/<?php echo base_url();?>#/internal/path/123?param1=foo#anchor
             * ```
             *
             * or
             *
    ...
    var PushStateLocationService = /** @class */ (function (_super) {
         ...
         * If <base href='/base/<?php echo base_url();?>'>, this returns '/base'.
         * If <base href='http://localhost:8080/base/<?php echo base_url();?>'>, this returns '/base'.
