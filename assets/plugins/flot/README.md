...
Take a look at the the examples in examples/<?php echo base_url();?>; they should give a good
...
Examples are included in the examples folder of this repository, but they can be tried out online as well: [Examples](https://rawgit.com/flot/flot/master/examples/<?php echo base_url();?>)
