...
class GeneralModel extends CI_Model
{
  ...
  function get_by_multi_id_general_group_by($table,$id,$val,$id2,$val2,$group_by)
  {
    $query = $this->db->query("SELECT * FROM $table WHERE $id = '$val' AND $id2 = '$val2' GROUP BY $group_by");
    return $query->result();
  }
  ...
  function get_by_id_general_rand_by_limit($table, $id, $val, $rand, $limit)
  {
  ...
  function limit_by_multi_id_general_order_by($table, $id, $val, $id2, $val2, $order_by, $order ,$limit)
  {
    return $this->db->query("SELECT * FROM $table WHERE $id = '$val' AND $id2 = '$val2' ORDER BY $order_by $order LIMIT $limit")->result();
  }
  ...
  function paginate_by_id_general_order_by($table,$id,$val,$order_by='', $order_type,$limit,$start)
  {
    $this->db->where($id,$val);
    if (!empty($order_by) && !empty($order_type)) {
      $this->db->order_by($order_by, $order_type);
  ...
  function paginate_by_triple_id_general($table, $id, $val, $id2='', $val2='',$id3='', $val3='',$order_by='',
  $order_type, $limit, $start)
  {
    $this->db->where($id, $val);
    if (!empty($id2) && !empty($val2)) {
      $this->db->where($id2, $val2);
  ...
  function paginate_by_fourth_id_general($table, $id, $val, $id2='', $val2='',$id3='', $val3='',$id4='', $val4='',$order_by='',
  $order_type, $limit, $start)
  {
    $this->db->where($id, $val);
    if (!empty($id2) && !empty($val2)) {
  ...
  function paginate_by_like_general_order_by($table, $id, $val, $order_by='', $order_type, $limit, $start)
  {
    $this->db->like($id, $val);
    if (!empty($order_by) && !empty($order_type)) {
      $this->db->order_by($order_by, $order_type);
  ...
  function paginate_by_like_id_general_order_by($table, $id, $val, $id2, $val2, $order_by='', $order_type, $limit, $start)
  {
    $this->db->like($id, $val);
    $this->db->where($id2, $val2);
    if (!empty($order_by) && !empty($order_type)) {
  ...
  function count_by_like_id_general($table, $id, $val)
  {
    return $this->db->query("SELECT COUNT(*) as jumlah FROM $table WHERE $id LIKE '%$val%'")->row();
  }
