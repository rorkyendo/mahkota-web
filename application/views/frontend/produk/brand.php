							...
							<div class="row">
								...
								<div class="col-lg-6 text-right">
									<ul class="sort-list">
										...
										<li class="<?php if($active == 'populer'){ echo "active";}?>"><a href="<?php echo base_url('produk/brand/populer/'.$search);?>">Populer</a></li>
										<li class="<?php if($active != 'populer' && $active != 'harga'){ echo "active";}?>"><a href="<?php echo base_url('produk/brand/'.$search);?>">Terbaru</a></li>
										<?php if($active == 'harga'):?>
										<li class="text">
...
<script type="text/javascript">
  ...
  function sort(val){
	location.replace('<?php echo base_url('produk/brand/'.$active.'/'.$search);?>?sort='+val)
  }
  ...
  function loadMoreData(page) {
    $.ajax({
        url: '<?php echo base_url('produk/brand/getData/'.$active);?>',
        data: 'from=' + page + '&brand=<?php echo $search; ?>&limit=3&sort=<?php echo $sort;?>',
        type: "get",
        beforeSend: function() {
          $('.ajax-load').show();
        }
