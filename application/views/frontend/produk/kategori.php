							...
							<div class="row">
								...
								<div class="col-lg-6 text-right">
									<ul class="sort-list">
										...
										<li class="<?php if($active == 'populer'){ echo "active";}?>"><a href="<?php echo base_url('produk/kategori/populer/'.$search);?>">Populer</a></li>
										<li class="<?php if($active != 'populer' && $active != 'harga'){ echo "active";}?>"><a href="<?php echo base_url('produk/kategori/'.$search);?>">Terbaru</a></li>
										<li class="<?php if($active == 'harga'){ echo "active";}?>"><a href="<?php echo base_url('produk/kategori/harga/'.$search);?>">Harga</a></li>
										<?php if($active == 'harga'):?>
										<li class="text">
...
<script type="text/javascript">
  ...
  function sort(val){
	location.replace('<?php echo base_url('produk/kategori/'.$active.'/'.$search);?>?sort='+val)
  }
  ...
  function loadMoreData(page) {
    $.ajax({
        url: '<?php echo base_url('produk/kategori/getData/'.$active);?>',
        data: 'from='+page+'&kategori=<?php echo $search; ?>&limit=3&sort=<?php echo $sort;?>',
        type: "get",
      })
      .done(function(data) {
        if (data == 0) {
		...
		setTimeout(() => {
			$("#from"+page).insertAfter("#from"+Number(page-3))
		}, 5000);
      })
