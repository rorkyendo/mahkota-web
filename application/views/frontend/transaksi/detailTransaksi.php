                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-bordered" style="width:100%">
                                <tr>
                                    ...
                                    <td align="right">Rp <?php echo number_format($subtotal->total_belanja,0,'.','.');?></td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-2">
                            <ul class="nav nav-list">
                                ...
                                <li><a href="<?php echo base_url('transaksi/payment/'.$row->id_temp_transaksi.'/'.$uuid_toko);?>" class="btn text-white btn-block btn-md btn-template">Pembayaran</a></li>
                            </ul>
                        </div>
                        <!-- END col-6 -->
                    </div>
