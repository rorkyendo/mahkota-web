            ...
            <div class="account-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="<?php echo base_url('user/createAddress/doCreate');?>" method="POST">
                            <label class="control-label">Nama Lengkap</label>
                            <div class="row m-b-15">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="nama" placeholder="Nama lengkap penerima" required />
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                            ...
                            <div class="row m-b-15">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="kode_pos"
                                        onkeypress="onlyNumberKey(this.event)" placeholder="Masukkan Kode Pos" required />
                                </div>
                            </div>
                            <label class="control-label">No HP/WA</label>
                            <div class="row m-b-15">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="nomor_hp" onkeypress="onlyNumberKey(this.event)" placeholder="No HP/WA" required/>
                                </div>
                            </div>
