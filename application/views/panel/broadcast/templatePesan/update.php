    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/broadcast/updateTemplate/doUpdate/'.$key->id_template)); ?>">
            <div class="col-md-12">
              <div class="form-group">
                <label class="col-md-2 control-label">Judul Template</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Judul Template" name="judul_template" value="<?php echo $key->judul_template;?>" required />
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Isi Pesan</label>
                <div class="col-md-10">
                  <textarea name="isi_pesan" class=" form-control" id="isi_pesan" cols="30" rows="10"><?php echo $key->isi_pesan;?></textarea>
