    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/transaksi/transaksiBaru/doCreate/')); ?>">
            <div class="col-md-12">
                ...
                <div class="col-md-10">
                  <select name="sales" class="form-control select2" id="sales">
                    ...
                    <?php foreach($sales as $key):?>
                      <option value="<?php echo $key->id_pengguna;?>"><?php echo $key->nip;?> | <?php echo $key->nama_lengkap;?></option>
                    <?php endforeach;?>
                  </select>
                </div>
              </div>
            ...
            <div class="form-group">
              <div class="col-md-12">
                ...
                <a href="<?php echo base_url(changeLink('panel/transaksi/daftarTransaksi/')); ?>" class="btn btn-sm btn-danger pull-right">Batal</a>
              </div>
            </div>
          </div>
        </form>
