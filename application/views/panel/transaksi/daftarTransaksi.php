    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="get" action="<?php echo base_url(changeLink('panel/transaksi/daftarTransaksi')); ?>">
            <div class="col-md-6">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $('#table').DataTable({
      ...
      "ajax": {
        "url": '<?php echo site_url(changeLink('panel/transaksi/daftarTransaksi/cari')); ?>',
        "type": "POST",
        "data":{
