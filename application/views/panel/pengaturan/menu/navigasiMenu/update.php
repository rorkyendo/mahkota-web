<?php foreach ($navigasiMenu as $row) : ?>
  <!-- begin #content -->
      ...
      <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
          ...
          <div class="panel-body">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/pengaturan/updateNavigasiMenu/doUpdate/' . $row->id)); ?>">
              <div class="col-md-12">
                <h4 class="text-center">Icon Menu</h4>
                <center>
                  <?php if(!empty($row->icon_menu)): ?>
                    <img src="<?php echo base_url().$row->icon_menu; ?>" class="img-responsive" alt="preview" id="preview"
                      style="height:150px">
                  <?php else: ?>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Masukkan Urutan" value="<?php echo $row->urutan; ?>" name="urutan" required />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">Nama menu</label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Masukkan Nama Menu" value="<?php echo $row->nama_menu; ?>" name="nama_menu" required />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">URL</label>
                  <div class="col-md-10">
                    <input type="text" class="form-control" placeholder="Masukkan URL" value="<?php echo $row->url; ?>" name="url" />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-2 control-label">Isi Menu</label>
                  <div class="col-md-10">
                    <textarea class="form-control" name="isi_menu" id="isi_menu"><?php echo $row->isi_menu; ?></textarea>
                  </div>
                </div>
                <script>
                  $("#isi_menu").summernote();
                ...
                <script>
                  $(document).ready(function() {
                    $('#jenis_menu').val('<?php echo $row->jenis_menu; ?>')
                ...
                <div class="form-group hidden" id="turunan">
                  ...
                  <script>
                    $('#menu_induk').val('<?php echo $row->menu_induk; ?>')
                  </script>
                </div>
                <div class="form-group hidden" id="utama">
                  <label class="col-md-2 control-label">Deskripsi Menu</label>
                  <div class="col-md-10">
                    <input type="text" name="deskripsi_menu" placeholder="Masukkan deskripsi menu" value="<?php echo $row->deskripsi_menu; ?>" class="form-control" id="deskripsi_menu">
                  </div>
                </div>
              </div>
              <div class="col-md-12">
