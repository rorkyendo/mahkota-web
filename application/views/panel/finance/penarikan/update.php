    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/finance/updatePenarikan/doUpdate/'.$key->id_penarikan)); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
              <div class="form-group">
                <label class="col-md-2 control-label">Jumlah Penarikan</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Jumlah Penarikan" name="jumlah_penarikan" value="<?php echo $key->jumlah_penarikan;?>" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Keterangan Rekening Penarikan</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Keterangan Rekening Penarikan (Mis : BNI xxxxxx an xxxxxx)" name="keterangan_rekening" value="<?php echo $key->keterangan_rekening;?>" required/>
                </div>
              </div>
            </div>
            <div class="col-md-12">
