    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/finance/tambahGroupAkun/doCreate/')); ?>">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <label class="col-md-2 control-label">Kode Group Akun Kas</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Kode Group Akun Kas" name="kode_group_kas" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Nama  Group Akun Kas</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Nama Group Akun Kas" name="nama_group_kas" required/>
                </div>
              </div>
            </div>
            <div class="form-group">
