          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/inventori/updateInventori/doUpdate/'.$row->id_inventori)); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
              <center>
                ...
                <?php if(!empty($row->barcode_image)): ?>
                  <img src="<?php echo base_url().$row->barcode_image;?>" class="img-responsive" alt="Barcode">
                <?php else: ?>
                  <b class="text-danger">Tidak ada barcode</b>
                <?php endif; ?>
              </center>
              <hr>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Barcode Inventori" name="barcode" value="<?php echo $row->barcode;?>" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Kode Inventori</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Kode Inventori" name="kode_inventori" value="<?php echo $row->kode_inventori;?>" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Nama Inventori</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Nama Inventori" name="nama_inventori" value="<?php echo $row->nama_inventori;?>" required/>
                </div>
              </div>
              <div class="form-group">
                ...
                <script>
                  $('#kode_satuan').val('<?php echo $row->kode_satuan;?>')
                </script>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Qty</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Qty" name="qty" value="<?php echo $row->qty;?>" step="0.01" required/>
                </div>
              </div>
              <div class="form-group">
                ...
                <script>
                  $('#gudang').val('<?php echo $row->gudang;?>')
                  $(document).ready(function(){
                    cariLokasi('<?php echo $row->gudang;?>')
                  })
                </script>
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Harga Beli Keseluruhan" name="harga_beli" value="<?php echo $row->harga_beli;?>" readonly/>
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Harga Modal Satuan" name="harga_modal" id="harga_modal" value="<?php echo $row->harga_modal;?>" required/>
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="number" class="form-control" value="<?php echo $row->harga_jual;?>" placeholder="Masukkan Harga Jual Toko" name="harga_jual" id="harga_jual" step="0.01" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Harga Jual Grosir</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" value="<?php echo $row->harga_jual_grosir;?>" placeholder="Masukkan Harga Jual Grosir" id="harga_jual_grosir" name="harga_jual_grosir" step="0.01"/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Harga Jual Online</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Harga Jual Online" value="<?php echo $row->harga_jual_online;?>" id="harga_jual_online" name="harga_jual_online" step="0.01"/>
                </div>
              </div>
            </div>
            <div class="form-group">
    ...
    $.ajax({
      ...
      data:{
        ...
        if(data!='false'){
          ...
          $('#lokasi_penyimpanan').val('<?php echo $row->lokasi_penyimpanan;?>')
        }else{
            Swal.fire(
              'Oopps..',
