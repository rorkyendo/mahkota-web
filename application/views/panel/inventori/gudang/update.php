    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/inventori/updateGudang/doUpdate/'.$key->id_gudang)); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
              <div class="form-group">
                <label class="col-md-2 control-label">Kode Gudang</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Kode Gudang" value="<?php echo $key->kode_gudang;?>" name="kode_gudang" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Nama Gudang</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Nama Gudang" name="nama_gudang" value="<?php echo $key->nama_gudang;?>" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Alamat Gudang</label>
                <div class="col-md-10">
                  <textarea name="alamat_gudang" id="alamat_gudang" class="form-control" cols="30" rows="10"><?php echo $key->alamat_gudang;?></textarea>
                </div>
              </div>
            </div>
            <div class="form-group">
