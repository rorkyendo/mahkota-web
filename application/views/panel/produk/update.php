    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/produk/updateProduk/doUpdate/'.$row->id_produk)); ?>"  enctype="multipart/form-data">
            <div class="col-md-3">
              <h4 class="text-center">Gambar 1</h4>
              <center>
                <?php if(!empty($row->foto_produk)): ?>
                  <img src="<?php echo base_url().$row->foto_produk; ?>" class="img-responsive" alt="preview_1" id="preview_1" style="height:150px">
                <?php else: ?>
            ...
            <div class="col-md-3">
              ...
              <center>
                <?php if(!empty($row->foto_produk_2)): ?>
                  <img src="<?php echo base_url().$row->foto_produk_2; ?>" class="img-responsive" alt="preview_2" id="preview_2" style="height:150px">
                <?php else: ?>
            ...
            <div class="col-md-3">
              ...
              <center>
                <?php if(!empty($row->foto_produk_3)): ?>
                  <img src="<?php echo base_url().$row->foto_produk_3; ?>" class="img-responsive" alt="preview_3" id="preview_3" style="height:150px">
                <?php else: ?>
            ...
            <div class="col-md-3">
              ...
              <center>
                <?php if(!empty($row->foto_produk_4)): ?>
                  <img src="<?php echo base_url().$row->foto_produk_4; ?>" class="img-responsive" alt="preview_4" id="preview_4" style="height:150px">
                <?php else: ?>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Barcode Produk" name="barcode" value="<?php echo $row->barcode;?>" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Nama Produk</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Nama Produk" name="nama_produk" value="<?php echo $row->nama_produk;?>" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Deskripsi Produk</label>
                <div class="col-md-10">
                  <textarea name="detail_produk" id="detail_produk" class="form-control" cols="30" rows="10"><?php echo $row->detail_produk;?></textarea>
                </div>
                <script>
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan PPN" name="ppn" value="<?php echo $row->ppn;?>" id="ppn" step="0.01" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Komisi</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Komisi" name="komisi" value="<?php echo $row->komisi;?>" id="komisi" step="0.01" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Potongan Member GOLD %</label>
                <div class="col-md-10">
                  <input type="number" name="potongan_member_gold" class="form-control" value="<?php echo $row->potongan_member_gold;?>" placeholder="Masukkan potongan member GOLD %">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Potongan Member BLUE %</label>
                <div class="col-md-10">
                  <input type="number" name="potongan_member_blue" class="form-control" value="<?php echo $row->potongan_member_blue;?>" placeholder="Masukkan potongan member BLUE %">
                </div>
              </div>
              <div class="form-group">
              ...
              <script>
                $('#jenis_point').val('<?php echo $row->jenis_point;?>')
                jenisPoint('<?php echo $row->jenis_point;?>')
                function jenisPoint(val){
                  if(val=='persen'){
                    $("#notePoint").text('Jumlah point akan dikalkulasikan dengan harga jual online');
                    $('#point_produk').val('')
                    if(val == '<?php echo $row->jenis_point;?>'){
                      $('#point_produk').val('<?php echo $row->point_produk;?>')
                    }
                  }else if(val=='saldo'){
            ...
            <script>
              $('#potongan_member').val('<?php echo $row->potongan_member;?>')
            </script>
            <div class="col-md-6">
              <div class="form-group">
                <label class="col-md-2 control-label">Berat Produk (gr)</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Berat Produk (gr)" name="berat_produk" value="<?php echo $row->berat_produk;?>" id="berat_produk" step="0.01" required/>
                </div>
              </div>
              <div class="form-group">
              ...
              <script>
                $('#status_cop').val('<?php echo $row->status_cop;?>')
                $(document).ready(function(){
                  statusCOP('<?php echo $row->status_cop;?>')
                })
              ...
              <div class="form-group" id="formInventori">
                ...
                <script>
                  $('#inventori').val('<?php echo $row->inventori;?>')
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="number" class="form-control" value="<?php echo $row->harga_modal;?>" placeholder="Masukkan Harga Modal" name="harga_modal" id="harga_modal" step="0.01" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Harga Jual</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" value="<?php echo $row->harga_jual;?>" placeholder="Masukkan Harga Jual" name="harga_jual" id="harga_jual" step="0.01" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Harga Jual Grosir</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Harga Jual" value="<?php echo $row->harga_jual_grosir;?>" name="harga_jual_grosir" id="harga_jual_grosir" step="0.01" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Harga Jual Online</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Harga Jual Online" value="<?php echo $row->harga_jual_online;?>" name="harga_jual_online" id="harga_jual_online" step="0.01" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Harga Diskon</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Harga Diskon" value="<?php echo $row->harga_diskon;?>" name="harga_diskon" id="diskon" />
                </div>
              </div>
              <div class="form-group">
                ...
                <script>
                  $('#kategori_produk').val('<?php echo $row->kategori_produk;?>')
                  $(document).ready(function(){
                    getBrand('<?php echo $row->kategori_produk;?>')
                  })
                </script>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <select name="tampil_toko" id="tampil_toko" class="form-control select2" style="width:100%" required>
                ...
                <script>
                  $('#tampil_toko').val('<?php echo $row->tampil_toko;?>')
                </script>
              </div>
              <div class="form-group">
                ...
                <script>
                  $('#wajib_asuransi').val('<?php echo $row->wajib_asuransi;?>')
                </script>
              <div class="form-group">
