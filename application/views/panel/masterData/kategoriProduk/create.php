    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/masterData/tambahKategoriProduk/doCreate/')); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Icon Kategori Produk" name="icon_kategori_produk"/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Nama Kategori Produk</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Nama Kategori Produk" name="nama_kategori_produk" required/>
                </div>
              </div>
            </div>
            <div class="form-group">
