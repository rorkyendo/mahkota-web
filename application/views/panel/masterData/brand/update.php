    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/masterData/updateBrand/doUpdate/'.$row->id_brand)); ?>" enctype="multipart/form-data">
            <div class="col-md-12">
              <h4 class="text-center">Gambar Brand</h4>
              <center>
                <?php if(!empty($key->gambar_brand)): ?>
                  <img src="<?php echo base_url().$key->gambar_brand; ?>" class="img-responsive" alt="preview" id="preview" style="height:150px">
                <?php else: ?>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Nama Brand" value="<?php echo $row->nama_brand;?>" name="nama_brand" required />
                </div>
              </div>
              <div class="form-group">
              ...
              <script>
                $("#kategori").val('<?php echo $row->kategori;?>')
              </script>
              <div class="form-group">
                <label class="col-md-2 control-label">Status Brand</label>
                <div class="col-md-10">
                  <select name="status_brand" id="status_brand" class="form-control">
                    <option value="">.:Pilih Status Brand:.</option>
              ...
              <script>
                $("#status_brand").val('<?php echo $row->status_brand;?>')
              </script>
            </div>
            <div class="form-group">
              <div class="col-md-12">
                ...
                <a href="<?php echo base_url(changeLink('panel/masterData/daftarBrand/')); ?>"
