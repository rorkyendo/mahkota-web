    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/masterData/tambahHakAkses/doCreate/')); ?>">
                    ...
                    <div id="<?php echo $key->class; ?>" class="panel-collapse collapse out">
                      <div class="panel-body">
                        <table class="table table-striped table-bordered">
                          ...
                          <tbody>
                            <?php
                            $modul = $this->GeneralModel->get_by_id_general_order_by('ms_modul', 'class_parent_modul', $key->class,'urutan_modul','ASC');
            ...
            <div class="col-md-12">
              <hr/>
              <a href="<?php echo base_url(changeLink('panel/masterData/hakAkses')); ?>" class="btn btn-sm red-sin text-white">Batal</a>
