    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/masterData/updateSatuan/doUpdate/'.$key->id_satuan)); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
              <div class="form-group">
                <label class="col-md-2 control-label">Kode Satuan</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Kode Satuan" name="kode_satuan" value="<?php echo $key->kode_satuan;?>" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Keterangan</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Keterangan" name="keterangan" value="<?php echo $key->keterangan;?>" required/>
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="col-md-12">
                ...
                <a href="<?php echo base_url(changeLink('panel/masterData/daftarSatuan/')); ?>" class="btn btn-sm btn-danger pull-right">Batal</a>
              </div>
            </div>
        </div>
        </form>
