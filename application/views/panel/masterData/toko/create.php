    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/masterData/tambahToko/doCreate/')); ?>"  enctype="multipart/form-data">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <h4 class="text-center">Etalase Toko</h4>
              <center>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Urutan Toko" name="urutan_toko" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Nama Toko</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Masukkan Nama Toko" name="nama_toko" required/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Email Owner</label>
                <div class="col-md-10">
                  <input type="email" class="form-control" placeholder="Masukkan Email Owner" name="email_owner" required />
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" onkeypress="onlyNumberKey(event)" placeholder="Masukkan No WA" name="no_wa" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">No Telp</label>
                <div class="col-md-10">
                  <input type="text" class="form-control" onkeypress="onlyNumberKey(event)" placeholder="Masukkan No Telp" name="no_telp" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Biaya Asuransi</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Biaya Asuransi" name="biaya_asuransi" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-2 control-label">Min Radius</label>
                <div class="col-md-10">
                  <input type="number" class="form-control" placeholder="Masukkan Min Radius" name="min_radius" />
