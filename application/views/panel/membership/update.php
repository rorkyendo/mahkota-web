...
<?php foreach($getMembership as $key):?>
<!-- begin #content -->
    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/membership/updateMembership/doUpdate/'.$key->id_member)); ?>">
          <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="col-md-10">
                    <select class="form-control select2" name="id_pengguna" required>
                        ...
                        <?php foreach($getPengguna as $key2): ?>
                            <option value="<?php echo $key2->id_pengguna; ?>" <?php if($key->id_pengguna == $key2->id_pengguna) { echo 'selected'; } ?>><?php echo $key2->nama_lengkap; ?> | <?php echo $key2->no_telp; ?></option>
                        <?php endforeach; ?> 
                    </select>
                </div>
              </div>
                ...
                <div class="col-md-10">
                    <select class="form-control" name="id_tipe_member" required>
                        ...
                        <?php foreach($getTipeMember as $u): ?>
                            <option value="<?php echo $u->id_tipe_member; ?>" <?php if($key->id_tipe_member == $u->id_tipe_member) { echo 'selected'; } ?>><?php echo $u->nama_tipe_member; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
              </div>
