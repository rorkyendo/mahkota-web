    ...
    <div class="col-md-12">
      ...
      <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-body">
          ...
          <form class="form-horizontal" method="post" action="<?php echo base_url(changeLink('panel/membership/tambahKupon/doCreate/')); ?>" enctype="multipart/form-data">
            <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" name="nama_kupon" required>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <textarea name="keterangan_kupon" id="keterangan_kupon" class="form-control" cols="30" rows="10"></textarea>
                  <script>
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <textarea name="syarat_ketentuan" id="syarat_ketentuan" class="form-control" cols="30" rows="10"></textarea>
                  <script>
            ...
            <div class="col-md-6">
               <div class="form-group">
                 ...
                 <div class="col-md-10">
                   <select name="tipe_member" id="tipe_member" class="form-control select2">
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-10">
                  <select name="status_min_belanja" id="status_min_belanja" onchange="statusMinBelanja(this.value)" class="form-control" required>
              ...
              <div class="form-group" id="formBelanja">
                ...
                <div class="col-md-10">
                  <input type="number" class="form-control" name="min_belanja" required>
                </div>
              </div>
               <div class="form-group">
                 <label class="col-md-2 control-label">Jenis Voucher</label>
                 <div class="col-md-10">
                   <select name="jenis_kupon" id="jenis_kupon" onchange="jenisKupon(this.value)" class="form-control" required>
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <input type="number" class="form-control" name="jml_kupon" required>
                </div>
              </div>
            </div>
            <hr />
            <div class="form-group">
              <div class="col-md-12">
                ...
                <a href="<?php echo base_url(changeLink('panel/membership/daftarKupon/')); ?>" class="btn btn-sm btn-danger pull-right">Batal</a>
              </div>
            </div>
        </div>
        </form>
